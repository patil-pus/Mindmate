...
const globalReducer = (state, action) => {
  switch (action.type) {
    ...
    case 'SET_THERAPISTS':
      return { ...state, therapists: action.payload, loading: false, error: null};
    case 'SET_LOADING':
...
export const GlobalProvider = ({ children }) => {
  ...
  return (
    <GlobalContext.Provider value={{ ...state, setUser, setClientData, setTherapists, setLoading, setError, logout, fetchUser, }}>
      {children}
